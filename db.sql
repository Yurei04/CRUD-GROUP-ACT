...
-- ===========================
-- 1. USERS TABLE
-- This table stores all accounts: customers, therapists, and administrators.
-- ===========================
...
-- Sample Therapists (Start at user_id 2)
...
-- Tracks individual bookings
-- ===========================
CREATE TABLE IF NOT EXISTS appointments (
appointment_id INT AUTO_INCREMENT PRIMARY KEY,
user_id INT NOT NULL,           -- The customer making the booking
therapist_id INT NOT NULL,      -- The therapist user providing the service
...
-- Blocks of time therapists are available
-- ===========================
CREATE TABLE IF NOT EXISTS availability (
availability_id INT AUTO_INCREMENT PRIMARY KEY,
therapist_id INT NOT NULL, -- References user_id where role is 'therapist'
date DATE NOT NULL,
start_time TIME NOT NULL,
end_time TIME NOT NULL,
...
-- Sample Availability (Using Maria Santos, Juan Dela Cruz, Anna Reyes - User IDs 2, 3, 4)
